...
import { Bell, ChevronLeft, Download, Search, Share2, Users } from "lucide-react"
import Link from "next/link"
import { useState } from "react"

export function EmployeeLifecycleHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-16 items-center gap-4 border-b bg-background px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-lg font-semibold tracking-tight hidden md:inline-block">员工全周期管理</span>
      </div>
      ...
      <div className="relative flex flex-1 items-center gap-4 md:gap-8 lg:gap-12">
        ...
        <div className={`${isSearchOpen ? "flex" : "hidden"} md:flex flex-1 items-center`}>
          ...
          <Input type="search" placeholder="搜索员工..." className="w-full pl-8 md:w-2/3 lg:w-1/3" />
        </div>
